                            ...
                            <div class="container-fluid container-fullw padding-bottom-10">
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-white no-radius" id="panelsocial">
                                            <div class="panel-heading border-light">
                                                <h4 class="panel-title">Personal Docente por Grupo de Edad</h4>
                                                        ...
                                                        <table class="table table-stylish" id="sample-table-2">
                                                            ...
                                                            <tbody>
                                                                @php
                                                                    ...
                                                                    $vTCantFD = 0;
                                                                @endphp 
                                                                @foreach($vRH_Ed_Docente as $vEFD)
                                                                    <tr id="tr_{{$vEFD->PK_ConcEstadistica}}">
                                                                        ...
                                                                        <td class="text-bold">
                                                                            {{ $vEFD->CantM + $vEFD->CantF }}
                                                                        </td>
                                                                        @php
                                                                            $vTCantMD = $vTCantMD + $vEFD->CantM;
                                                                            $vTCantFD = $vTCantFD + $vEFD->CantF;
                                                                        @endphp 
                                                                    </tr>
                                                                @endforeach
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                            <div class="panel panel-white no-radius" id="panelsocial">
                                                <div class="panel-heading border-light">
                                                    <h4 class="panel-title">Personal Administrativo por Grupo de Edad</h4>
                                                    <div class="panel-tools">
                                                        <a data-original-title="Minimizar" data-toggle="tooltip" data-placement="top" data-trigger="hover" class="btn btn-transparent btn-sm panel-collapse" href="#"><i class="ti-minus collapse-off"></i><i class="ti-plus collapse-on"></i></a>
                                                        <a data-original-title="Cerrar" data-toggle="tooltip" data-placement="top" data-trigger="hover" class="btn btn-transparent btn-sm panel-close" href="#"><i class="ti-close"></i></a>
                                                    </div>
                                                            ...
                                                            <table class="table table-stylish" id="sample-table-2">
                                                                ...
                                                                <tbody>
                                                                    @php
                                                                        ...
                                                                        $vTCantFA = 0;
                                                                    @endphp 
                                                                    @foreach($vRH_Ed_Administrativo as $vAEA)
                                                                        <tr id="tr_{{$vAEA->PK_ConcEstadistica}}">
                                                                            <td class="text-bold center">
                                                                                {{ $xA++ }}
                                                                            </td>
                                                                            <td class="text-bold">
                                                                            ...
                                                                            <td class="text-bold">
                                                                                {{ $vAEA->CantM + $vAEA->CantF }}
                                                                            </td>
                                                                            @php
                                                                                $vTCantMA = $vTCantMA + $vAEA->CantM;
                                                                                $vTCantFA = $vTCantFA + $vAEA->CantF;
                                                                            @endphp 
                                                                        </tr>
                                                                    @endforeach
    ...
    <script>
        ...
        var Charts = function() {"use strict";
            ...
            var barChartHandler = function() {
                ...
                var data = {
                    labels: [@foreach($vRH_Ed_Docente as $vTitD) "{{ $vTitD->CES_Nombre }}", @endforeach],
                    ...
                    datasets: [{
                        ...
                        data: [@foreach($vRH_Ed_Docente as $vCMD) {{ $vCMD->CantM }}, @endforeach]
                    }, {
                        label: "Mujer",
                        ...
                        data: [@foreach($vRH_Ed_Docente as $vCFD) {{ $vCFD->CantF }}, @endforeach]
                    }]
                };
            ...
            var barChartHandler2 = function() {
                ...
                var data = {
                    labels: [@foreach($vRH_Ed_Administrativo as $vTitA) "{{ $vTitA->CES_Nombre }}", @endforeach],
                    ...
                    datasets: [{
                        ...
                        highlightFill: "rgba(91, 155, 209,0.75)",
                        highlightStroke: "rgba(91, 155, 209,1)",
                        data: [@foreach($vRH_Ed_Administrativo as $vCMA) {{ $vCMA->CantM }}, @endforeach]
                    }, {
                        label: "Mujer",
                        fillColor: "rgba(245,136,141,0.5)",
                        strokeColor: "rgba(245,136,141,0.8)",
                        highlightFill: "rgba(245,136,141,0.75)",
                        highlightStroke: "rgba(245,136,141,1)",
                        data: [@foreach($vRH_Ed_Administrativo as $vCFA) {{ $vCFA->CantF }}, @endforeach]
                    }]
                };
