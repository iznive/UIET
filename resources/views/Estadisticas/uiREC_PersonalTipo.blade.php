                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-white no-radius" id="panelsocial">
                                            <div class="panel-heading border-light">
                                                <h4 class="panel-title">Personal  por Tipo</h4>
                                                        ...
                                                        <table class="table table-stylish" id="sample-table-2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="no-border">Tipo Personal</th>
                                                                    <th class="no-border">
                                                                        Hombre 
    ...
    <script>
        ...
        var Charts = function() {"use strict";
            ...
            var barChartHandler = function() {
                ...
                var data = {
                    labels: [@foreach($vREC_PersTipo as $vTitD) "{{ $vTitD->PersTipo }}", @endforeach],
                    ...
                    datasets: [{
                        ...
                        data: [@foreach($vREC_PersTipo as $vCMD) {{ $vCMD->CantM }}, @endforeach]
                    }, {
                        label: "Mujer",
                        ...
                        data: [@foreach($vREC_PersTipo as $vCFD) {{ $vCFD->CantF }}, @endforeach]
                    }]
                };
