                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-white no-radius" id="panelsocial">
                                            <div class="panel-heading border-light">
                                                <h4 class="panel-title">Personal Docente por Tiempo de Dedicación</h4>
                                                        ...
                                                        <table class="table table-stylish" id="sample-table-2">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="no-border">Tipo de Contratación</th>
                                                                    <th class="no-border">
                                                                        Hombre 
                                                            ...
                                                            <tbody>
                                                                @php
                                                                    ...
                                                                    $vTCantFD = 0;
                                                                @endphp 
                                                                @foreach($vRH_Tiempo as $vT)
                                                                    <tr id="tr_{{$vT->PK_ConcEstadistica}}">
    ...
    <script>
        ...
        var Charts = function() {"use strict";
            ...
            var barChartHandler = function() {
                ...
                var data = {
                    labels: [@foreach($vRH_Tiempo as $vTitD) "{{ $vTitD->CES_Nombre }}", @endforeach],
                    ...
                    datasets: [{
                        ...
                        data: [@foreach($vRH_Tiempo as $vCMD) {{ $vCMD->CantM }}, @endforeach]
                    }, {
                        label: "Mujer",
                        ...
                        data: [@foreach($vRH_Tiempo as $vCFD) {{ $vCFD->CantF }}, @endforeach]
                    }]
                };
