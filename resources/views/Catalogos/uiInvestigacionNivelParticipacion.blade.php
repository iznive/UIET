                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        ...
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nueva Investigación Nivel Participación"> 
                                            <i class="fa fa-plus"></i> Nueva Investigación Nivel Participación
                                        </a>
                                        <p>
                                            Información de las Investigaciones Nivel Participación
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vInvestigacion as $vInv)
                                                    <tr id="tr_{{$vInv->PK_InveNivePart}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                        <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funInvestigacionNivelParticipacionEditarForm({{$vInv->PK_InveNivePart}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funInvestigacionNivelParticipacionEliminar({{$vInv->PK_InveNivePart}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funBitacora('t_investigacion_nivelparticipacion', {{$vInv->PK_InveNivePart}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="HiPK_InveNivePart" name="HiPK_InveNivePart" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Nombre de la Investigación Nivel Participación <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder=" " class="form-control" id="TeINP_Nombre" name="TeINP_Nombre" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Observación <span class="symbol required"></span> </label>
                                                    <textarea type="text" placeholder=" " class="form-control" id="TeAObservacion_InvestigacionParticipacion" name="TeAObservacion_InvestigacionParticipacion" /></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funInvestigacionNivelParticipacionGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsInvestigacionNP.js?v=1') }}"></script>
