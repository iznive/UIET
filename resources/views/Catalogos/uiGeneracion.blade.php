                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nueva Generación"> 
                                            <i class="fa fa-plus"></i> Nueva Generación
                                        </a>
                                        <p>
                                            Información sobre las Generaciones.
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
													 <th>Año Generación</th> 
                                                     <th>Nombre Generación</th> 
                                                     <th>Nombre Corto Generación</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vGeneracion as $vG)
                                                    <tr id="tr_{{$vG->PK_Generacion}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                         <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funGeneracionEditarForm({{$vG->PK_Generacion}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                        <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funGeneracionEliminar({{$vG->PK_Generacion }} )"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                 	<th>
                                                                        <button onclick="funBitacora('t_Generacion', {{$vG->PK_Generacion}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="hiPK_Generacion" name="hiPK_Generacion" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Año Generación <span class="symbol required"></span> </label>
                                                    <input type="date" placeholder="" class="form-control" id="DaGen_Ano" name="DaGen_Ano" />
                                                       <label class="control-label"> Nombre Generación <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="Nombre Generación   maxlength="50" minlength="3"  class="form-control" id="TeGen_Nombre" name="TeGen_Nombre" />
                                                       <label class="control-label"> Nombre Corto Generación <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="maximo 5 caracteres" class="form-control" id="TeGen_NombreCorto" name="TeGen_NombreCorto"  maxlength="5" minlength="2"  />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funGeneracionGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsGeneracion.js?v=1') }}"></script>
