...
@section('customBread')
    ...
    <div class="breadcrumb-wrapper">
        <h4 class="mainTitle no-margin">Sede</h4>
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nueva Sede"> 
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($vSede as $vS)
                                                    <tr id="tr_{{$vS->PK_Sede}}">
                                                        ...
                                                        <td>
                                                            {{$vS->Sed_Direccion}}, {{$vS->Loc_Nombre}}, {{$vS->Mun_Nombre}}, {{$vS->EFe_Nombre}}, {{$vS->Pai_NombreCorto}}
                                                        </td>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funSedeEditar({{$vS->PK_Sede}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funSedeEliminar({{$vS->PK_Sede}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funBitacora('t_sede', {{$vS->PK_Sede}})" data-toggle="modal" data-target=".Mod_Bitacora" class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden"  id="HiPK_Sede" name="HiPK_Sede" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Nombre  <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="Oxolotán" class="form-control" id="TeNombreSede" name="TeNombreSede">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Teléfono </label>
                                                    <input type="text" placeholder="(993) 353-2474" class="form-control" id="TeTelefonoSede" name="TeTelefonoSede" />
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label"> Dirección <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="Jacinto Ticoman" class="form-control" id="TeDireccionSede" name="TeDireccionSede">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3" id="divSeEntidad">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single js-states form-control SeEntidad" name="SeEntidad" id="SeEntidad" style="width: 100% !important">
                                                        <option value="x1">Seleccionar</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funSedeGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsSede.js?v=12') }}"></script>
