                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        ...
                                        <p>
                                            Información de las Categorías de Puestos.
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vCategoriaPuesto as $vC)
                                                    <tr id="tr_{{$vC->PK_CatePuesto}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                        <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funCategoriaPuestoEditarForm({{$vC->PK_CatePuesto}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funCategoriaPuestoEliminar({{$vC->PK_CatePuesto}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funBitacora('t_categoriapuesto', {{$vC->PK_CatePuesto}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="HiPK_CatePuesto" name="HiPK_CatePuesto" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Nombre <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="Jefe de Departamento A" class="form-control" id="TeCPu_Nombre" name="TeCPu_Nombre" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funCategoriaPuestoGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsCategoriaPuesto.js?v=1') }}"></script>
