                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        ...
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nuevo Municipio">
                                                    ...
                                                    <tr id="tr_{{$vM->PK_Municipio}}">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funMunicipioEditarForm({{$vM->PK_Municipio}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funMunicipioEliminar({{$vM->PK_Municipio}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funBitacora('t_municipio', {{$vM->PK_Municipio}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="HiPK_Municipio" name="HiPK_Municipio" value="-99">
                                        <div class="row">
                                            <div class="col-md-6" id="divSeFK_Entidad">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single js-states form-control SeFK_Entidad" name="SeFK_Entidad" id="SeFK_Entidad" style="width: 100% !important">
                                                        ...
                                                        @foreach($vEntidad as $vE)
                                                            <option value="{{ $vE->PK_Entidad }}">{{ $vE->EFe_Nombre }} ({{ $vE->Pai_NombreCorto }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Centro" class="form-control" id="TeMun_Nombre" name="TeMun_Nombre"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" placeholder="Observación" class="form-control" id="TeAObservacion_Municipio" name="TeAObservacion_Municipio" /></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funMunicipioGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsMunicipio.js?v=1') }}"></script>
