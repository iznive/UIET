                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nuevo Situación Postgrado"> 
                                            <i class="fa fa-plus"></i> Nuevo Situación Postgrado
                                        </a>
                                        <p>
                                            Información sobre Situación de Postgrado.
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vPostgradoSituacion as $vPS)
                                                    <tr id="tr_{{$vPS->PK_PostSituacion}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                         <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funPostgradoSituacionEditarForm({{$vPS->PK_PostSituacion}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                        <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funPostgradoSituacionEliminar({{$vPS->PK_PostSituacion }} )"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                 	<th>
                                                                        <button onclick="funBitacora('t_postgradosituacion', {{$vPS->PK_PostSituacion}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="hiPK_PostSituacion" name="hiPK_PostSituacion" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Situación Postgrado <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="Nombre Situación Postgrado" class="form-control" id="TePSi_Nombre" name="TePTi_Nombre" maxlength="50" minlength="2" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funPostgradoSituacionGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsPostgradoSituacion.js?v=1') }}"></script>
