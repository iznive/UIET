                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        ...
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nueva Categoría"> 
                                            <i class="fa fa-plus"></i> Nueva Vinculación Nivel Participacion
                                        </a>
                                        <p>
                                            Información de las Vinculaciones Nivel Participacion
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vVinculacion as $vVin)
                                                    <tr id="tr_{{$vVin->PK_VincNivePart}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                        <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funVinculacionNivelParticipacionEditarForm({{$vVin->PK_VincNivePart}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funVinculacionNivelParticipacionEliminar({{$vVin->PK_VincNivePart}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funBitacora('t_vinculacion_nivelparticipacion', {{$vVin->PK_VincNivePart}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="HiPK_VincNivePart" name="HiPK_VincNivePart" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Nombre de la Vinculación Nivel Participación<span class="symbol required"></span> </label>
                                                    <input type="text" placeholder=" " class="form-control" id="TeVNP_Nombre" name="TeVNP_Nombre" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Observación </label>
                                                    <textarea type="text" placeholder=" " class="form-control" id="TeAObservacion_VinculacionParticipacion" name="TeAObservacion_VinculacionParticipacion" /></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funVinculacionNivelParticipacionGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsVinculacionNP.js?v=1') }}"></script>
