                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Superior Jerárquico"> 
                                            <i class="fa fa-plus"></i> Nuevo Superior Jerárquico
                                        </a>
                                        <p>
                                            Información de los Superiores Jerárquico.
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vSupeJerarquico as $vS)
                                                    <tr id="tr_{{$vS->PK_SupeJerarquico}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                        <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funSuperiorJerarquicoEditarForm({{$vS->PK_SupeJerarquico}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funSuperiorJerarquicoEliminar({{$vS->PK_SupeJerarquico}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funBitacora('t_superiorjerarquico', {{$vS->PK_SupeJerarquico}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="HiPK_SupeJerarquico" name="HiPK_SupeJerarquico" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Nombre <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="x" class="form-control" id="TeSJe_Nombre" name="TeSJe_Nombre" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="x" class="form-control" id="TeSJe_Abreviatura" name="TeSJe_Abreviatura" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funSuperiorJerarquicoGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/assets/js/table-data.js?v=8') }}"></script>
    <script src="{{ asset('/js/Varios/jsSelect.js?v=1') }}"></script>
    <script src="{{ asset('/js/Varios/jsApp.js?v=2') }}"></script>
    <script src="{{ asset('/js/Catalogos/jsSuperiorJerarquico.js?v=4') }}"></script>
