                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nuevo Tipo Postgrado"> 
                                            <i class="fa fa-plus"></i> Nuevo Tipo Postgrado
                                        </a>
                                        <p>
                                            Información sobre los Tipos Postgrado.
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vPostgradoTipo as $vPT)
                                                    <tr id="tr_{{$vPT->PK_PostTipo}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                         <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funPostgradoTipoEditarForm({{$vPT->PK_PostTipo}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                        <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funPostgradoTipoEliminar({{$vPT->PK_PostTipo }} )"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                 	<th>
                                                                        <button onclick="funBitacora('t_postgradotipo', {{$vPT->PK_PostTipo}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="hiPK_PostTipo" name="hiPK_PostTipo" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Tipo Postgrado <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="Nombre Tipo Postgrado" class="form-control" id="TePTi_Nombre" name="TePTi_Nombre" maxlength="50" minlength="2" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funPostgradoTipoGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsPostgradoTipo.js?v=1') }}"></script>
