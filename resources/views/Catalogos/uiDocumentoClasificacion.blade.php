                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                        ...
                                        <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nueva Clasificacion de documento"> 
                                            <i class="fa fa-plus"></i> Nueva Clasificación
                                        </a>
                                        <p>
                                            Información de las Clasificaciones de Documentos.
                                        </p>
                                        <hr>
                                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php
                                                    $x = 1;
                                                ?>
                                                @foreach($vDocumentoClasificacion as $vDCl)
                                                    <tr id="tr_{{$vDCl->PK_DocuClasificacion}}">
                                                        <td class="text-bold">
                                                            {{ $x++ }}
                                                        </td>
                                                        <td class="text-bold">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <th>
                                                                        <button onclick="funDocumentoClasificacionEditarForm({{$vDCl->PK_DocuClasificacion}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funDocumentoClasificacionEliminar({{$vDCl->PK_DocuClasificacion}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </th>
                                                                    <th>&nbsp;</th>
                                                                    <th>
                                                                        <button onclick="funBitacora('t_documentos_clasificacion', {{$vDCl->PK_DocuClasificacion}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="HiPK_DocuClasificacion" name="HiPK_DocuClasificacion" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Nombre de la clafificación del documento <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="Documentación General" class="form-control" id="TeDCl_Nombre" name="TeDCl_Nombre"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Observación</label>
                                                    <textarea type="text"  class="form-control" id="TeAObservacion_Clasificacion" name="TeAObservacion_Clasificacion"/></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funDocumentoClasificacionGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/js/Catalogos/jsDocumentoClasificacion.js?v=7') }}"></script>
