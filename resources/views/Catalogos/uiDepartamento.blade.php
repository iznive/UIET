                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="myTab1_example1">
                                    <a href="#myTab1_example2" class="btn btn-primary btn-o show-tab pull-right" data-toggle="tooltip" title="Crear Nuevo Departamento"> 
                                                ...
                                                <tr id="tr_{{$vD->PK_Departamento}}">
                                                    ...
                                                    <td>
                                                        <table>
                                                            <tr>
                                                                <th>
                                                                    <button onclick="funDepartamentoEditarForm({{$vD->PK_Departamento}})" href="#myTab1_example2" class="btn search-button show-tab" data-toggle="tooltip" title="Editar">
                                                                        <i class="fa fa-edit"></i>
                                                                    </button>
                                                                </th>
                                                                <th>&nbsp;</th>
                                                                <th>
                                                                    <button onclick="funDepartamentoEliminar({{$vD->PK_Departamento}})"  class="btn search-button" data-toggle="tooltip" title="Eliminar">
                                                                        <i class="fa fa-trash"></i>
                                                                    </button>
                                                                </th>
                                                                <th>&nbsp;</th>
                                                                <th>
                                                                    <button onclick="funBitacora('t_departamento', {{$vD->PK_Departamento}})" data-toggle="modal" data-target=".Mod_Bitacora"  class="btn search-button" data-toggle="tooltip" title="Bitacora">
                                ...
                                <div class="tab-pane fade" id="myTab1_example2">
                                    <form action="#" role="form" id="form" name="form">
                                        <input type="hidden" id="HiPK_Departamento" name="HiPK_Departamento" value="-99">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Nombre <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="x" class="form-control" id="TeDep_Nombre" name="TeDep_Nombre" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Abreviatura <span class="symbol required"></span> </label>
                                                    <input type="text" placeholder="x" class="form-control" id="TeDep_Abreviatura" name="TeDep_Abreviatura" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button onclick="funDepartamentoGuardar()" class="btn btn-primary btn-wide pull-right">
...
@section('customScript2')
    ...
    <script src="{{ asset('/assets/js/form-validation.js?v=13') }}"></script>
    ...
    <script src="{{ asset('/js/Catalogos/jsDepartamento.js?v=4') }}"></script>
